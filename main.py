...
from buff_system import is_buff_active, get_active_buff_totals
from characters.navia import (
    get_navia_elemental_skill_multiplier,
    get_navia_elemental_skill_base_multiplier,
    calculate_navia_skill_damage,
    calculate_navia_burst_damage,
)
from characters.nicole import get_nicole_skill_buff, get_nicole_skill_dmg
